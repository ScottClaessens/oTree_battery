...
class Player(BasePlayer):
    comprehension = models.IntegerField(
        label="If Person B transfers and Person A doesn't, how many points will they each have at the end of the "
              "transfer phase?",
        choices=[
            [1, 'A will have 100 (100 start - 0 transferred), B will have 130 (100 start - 30 transferred + 60 received)'],
            [2, 'A will have 160 (100 start + 60 received - 0 transferred), B will have 70 (100 start - 30 transferred)'],
